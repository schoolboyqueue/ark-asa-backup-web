...
export interface UseBackupFiltersReturn {
  ...
  filteredBackups: BackupMetadata[];
 ...
 *
 * @param {BackupMetadata[]} backups - Array of backups to filter
 ...
 * ```
 */
export function useBackupFilters(backups: BackupMetadata[]): UseBackupFiltersReturn {
