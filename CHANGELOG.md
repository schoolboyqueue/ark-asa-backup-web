...
- Auto-refresh relative time displays every 30 seconds
- Improve NumberFlow alignment and simplify copy button feedback
- Resolve graceful shutdown timeout and add missing HeroUI theme dependency
- Stabilize SSE callbacks to prevent missed real-time updates

### Performance Improvements
- Optimize Docker image size by removing unnecessary build tools (553MB → 245MB, 56% reduction)
